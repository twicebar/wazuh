    ...
    for c, cve in iter(data['ScannedCves'].items()):
        ...
        for p in cve['AffectedPackages']:
            ...
            if package_info:
                ...
                msg['affected_packages_info'][name]['version'] = package['Version']
                msg['affected_packages_info'][name]['release'] = package ['Release']
                msg['affected_packages_info'][name]['new_version'] = package ['NewVersion']
                msg['affected_packages_info'][name]['new_release'] = package ['NewRelease']
                msg['affected_packages_info'][name]['arch'] = package ['Arch']
                msg['affected_packages_info'][name]['repository'] = package ['Repository']
                msg['affected_packages_info'][name]['fixable'] = 'Yes' if p['NotFixedYet'] == False else 'No'
